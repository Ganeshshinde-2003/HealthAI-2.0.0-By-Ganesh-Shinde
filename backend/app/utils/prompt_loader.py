"""
Prompt Loading Utilities for HealthAI Backend
...
def load_prompt_template(filename: str) -> str:
    ...
    backend_dir = os.path.dirname(app_dir)  # backend directory
    filepath = os.path.join(backend_dir, 'prompts', filename)
...
def load_json_schema(filename: str) -> Dict:
    ...
    app_dir = os.path.dirname(current_dir)  # app directory
    backend_dir = os.path.dirname(app_dir)  # backend directory
    filepath = os.path.join(backend_dir, 'prompts', 'schemas', filename)
